                ...
                <div class="col-12 col-md-12 col-lg-12">
                    <div class="alert alert-danger alert-has-icon alert-dismissible show fade">
                        ...
                        <div class="alert-body">
                            ...
                            Pinjaman anda pada {{ date('d F Y', strtotime($u->tgl_pinjaman)) }} sudah jatuh tempo <br>
                            Silahkan anda melunasinya
                        </div>
                    </div>
                </div>
            @endif
                                    ...
                                    @foreach ($utang as $u)
                                            ...
                                            <li class="media">
                                                ...
                                                <div class="media-body">
                                                    <p>Pinjaman anda pada
                                                        {{ date('d F Y', strtotime($u->tgl_pinjaman)) }} sudah jatuh
                                                        tempo
                                                    </p>
                                                </div>
                                            </li>
                                        ...
                                        @else
                                            <li class="media">
                                                ...
                                                <div class="media-body">
                                                    <p>Pinjaman anda pada
                                                        {{ date('d F Y', strtotime($u->tgl_pinjaman)) }} sudah Lunas
                                                    </p>
                                                </div>
                                            </li>
                                        @endif
